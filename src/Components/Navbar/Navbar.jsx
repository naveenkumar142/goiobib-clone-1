  ...
  return (
    <div>
      <div className="class" style={{justifyContent:"space-around"}}>
        ...
        <ul class="happy-nav" style={{ fontSize: "11px",justifyContent:"space-evenly"}}>
          <li class="  ">
        ...
        <div className="gr-make-flex hrtl-center gr-push-right">
          ...
          <div className="login__tab gotrible" role="presentation" style={{fontSize:"24px"}}>
            ...
            <div className="gr-font10" role="presentation" id="get_sign_in">
              {token ? (
                ...
                <p
                  ...
                  style={{fontSize:"16px",fontFamily:"-moz-initial"}}
                >
                  Login or Signup
                </p>
              )}
        ...
        <div id="id01" className="sign-in">
          <div className="modal-content" action="">
            ...
            <div className="right-container">
              ...
              <div>
                <h2 style={{fontSize:"18px"}}>Login/SignUp</h2>
                <form onSubmit={onSignInSubmit}>
                  <div className="login-details-div" style={{color:"black"}}>
