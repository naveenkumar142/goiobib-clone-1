            ...
            <section className="eLJizy">
                <div className="jwnhYD">
                    {/* <div className="eMfvSP">
                        ...
                        <span className="iLdzQD">Happy Journey</span>
                         </div>
                    </div> */}
                        ...
                        <div className="righside-start">
                            ...
                            <div className="cnOKAm">
                                <img src="https://wallpaperaccess.com/full/1628627.jpg" width="99%" height="200%"/>
                            </div>
                            <div className="cnOKAm" style={{marginTop:"10px"}}>
                                <img src="https://wallpaperaccess.com/full/1628641.jpg" width="99%" height="200%"/>
                            </div>
